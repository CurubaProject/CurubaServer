...
var Request = {	
	...
	SETDEVICECONFIGURATIONINSERTSCHEDULE : 'INSERT INTO ConfigSchedule (DeviceState, DeviceValue) VALUES (%s, %s);INSERT INTO ScheduleDevice (ScheduleType, DeviceId, Minute, Hour, ScheduleConfigId ) VALUES (0,%s,%s,%s, LAST_INSERT_ID() );SELECT LAST_INSERT_ID() ScheduleTO;INSERT INTO ConfigSchedule (DeviceState, DeviceValue) VALUES (%s, %s);INSERT INTO ScheduleDevice (ScheduleType, DeviceId, Minute, Hour, ScheduleConfigId, ScheduleDeviceIdTo) VALUES (0,%s,%s,%s, LAST_INSERT_ID(), ScheduleTO );',
